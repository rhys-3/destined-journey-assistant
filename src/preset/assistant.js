...
export async function startPresetAssistant() {
  ...
  const ctx = {
    ...
    get clearLengthDraft() { return clearLengthDraft; },
    ...
    get hasLengthRequirementMacro() { return hasLengthRequirementMacro; },
    ...
    get readLengthControl() { return readLengthControl; },
    ...
    get setLengthMode() { return setLengthMode; },
    get setLengthValue() { return setLengthValue; },
